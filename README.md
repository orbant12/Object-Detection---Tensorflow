...
<br /> <br/>
<u>Final Step: </u> Once you get to step 6. Train the model, inside of the notebook, you may choose to train the model from cmd within the virtual enviroment for live loss metrics.
<br />
